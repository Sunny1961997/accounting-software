...
export default function NewBankCollectionPage() {
  return (
    <div className="max-w-4xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/cash/bank-collection" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
          <span className="text-black">ব্যাংক আদায় / নতুন অর্থ সংগ্রহ</span>
        </Link>
      </div>

      <div className="bg-white rounded-lg shadow-sm p-6">
        <h1 className="text-xl font-bold mb-6 text-black">ব্যাংক আদায়</h1>
        ...
        <form className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm mb-2 text-black">পেমেন্ট</label>
            ...
            <div>
              <label className="block text-sm mb-2 text-black">মোট আদায়</label>
              <div className="flex items-center gap-2">
                <span className="text-gray-600">৳</span>
                <input
                  type="number"
            ...
            <div>
              <label className="block text-sm mb-2 text-black">অবশিষ্ট পাওনা</label>
              <div className="flex items-center gap-2">
                <span className="text-gray-600">৳</span>
                <input
                  type="number"
          ...
          {/* Checkbox */}
          <div className="flex items-center gap-2">
            <input type="checkbox" id="linkSms" className="w-4 h-4" />
            <label htmlFor="linkSms" className="text-sm text-black">বিল আদায়ের এসএমএস পাঠান</label>
          </div>
