...
export default function NewSalePage() {
  ...
  const [sendDueMessage, setSendDueMessage] = useState(false);
  ...
  const handleSaveAndNew = () => {
    ...
    alert('বিক্রয় সেভ হয়েছে');
    setPartySearch('');
    setItems([{ id: 1, name: '', quantity: 1, price: 0, total: 0.00 }]);
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-black mb-6">বিক্রয় / নতুন বিক্রয়</h1>

      <div className="bg-white rounded-lg shadow">
        {/* Header */}
        <div className="bg-purple-50 border-b border-purple-200 px-6 py-3 rounded-t-lg flex items-center justify-between">
          <h2 className="text-base font-bold text-purple-800">নতুন বিক্রয়</h2>
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap items-start gap-6 mb-4">
            ...
            <div className="flex items-center gap-4">
              <div>
                <label className="text-sm text-black mb-1 block">ইনভয়েস নং</label>
                <input
                  type="text"
                  value={invoiceNo}
              ...
              <div>
                <label className="text-sm text-black mb-1 block">ইনভয়েসের তারিখ</label>
            ...
            {items.map((item, index) => (
              <div key={item.id} className="flex items-center gap-4 mb-2">
                ...
                <input
                  ...
                  className="w-28 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none text-black text-right"
                />
                <span className="w-28 text-sm text-black text-right">{item.total.toFixed(2)}</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4">
            ...
            <div className="bg-purple-50/50 rounded-lg border border-purple-100 p-4">
              ...
              <label className="flex items-center gap-2 mt-3">
                <input
                  type="checkbox"
                  checked={sendDueMessage}
                  onChange={(e) => setSendDueMessage(e.target.checked)}
                  className="rounded border-gray-300"
                />
                <span className="text-sm text-black">বাকির মেসেজ পাঠান</span>
              </label>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-end gap-4">
                <span className="text-sm text-black">ডেলিভারি চার্জ:</span>
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="w-32 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none text-black text-right"
                  />
                </div>
              </div>
              <div className="flex items-center justify-end gap-4">
                <span className="text-sm text-black">পেলাম:</span>
                <div className="flex items-center">
                  <span className="text-sm text-black mr-1">৳</span>
                  <input
                    type="number"
              ...
              <div className="flex items-center justify-end gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    value={totalPrice}
                    readOnly
                    className="w-32 px-3 py-2 border border-gray-200 rounded-lg outline-none text-black text-right bg-gray-50"
                  />
                </div>
              </div>
              <div className="flex items-center justify-end gap-4">
