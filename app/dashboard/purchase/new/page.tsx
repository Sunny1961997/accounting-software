...
export default function NewPurchasePage() {
  ...
  const [billNo, setBillNo] = useState('378614917888');
  const [billDate, setBillDate] = useState('28-02-2026');
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-black mb-6">ক্রয় / নতুন ক্রয়</h1>

      <div className="bg-white rounded-lg shadow">
        {/* Header */}
        <div className="bg-purple-50 border-b border-purple-200 px-6 py-3 rounded-t-lg flex items-center justify-between">
          <h2 className="text-base font-bold text-purple-800">নতুন ক্রয়</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-end">
                <span className="text-base font-bold text-black">দিলাম: ৳ {due.toFixed(2)}</span>
              </div>
            </div>
          </div>
