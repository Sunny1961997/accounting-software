    ...
    <div className="bg-white rounded-lg shadow-sm">
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-medium text-black">বিল এস নাম</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-black">কোড</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-black">থোক নাম</th>
              <th className="px-6 py-3 text-right text-sm font-medium text-black">উৎসব মূল</th>
              <th className="px-6 py-3 text-right text-sm font-medium text-black">ভাস</th>
              <th className="px-6 py-3 text-right text-sm font-medium text-black">ডাউনলোড মূল</th>
            </tr>
          </thead>
              ...
              <tr key={party.id} className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-black">{party.name}</span>
                  </div>
                </td>
                <td className="px-6 py-4 text-sm text-purple-600">{party.type}</td>
                <td className="px-6 py-4 text-sm text-black"></td>
                <td className="px-6 py-4 text-sm text-right text-black">{party.balance}</td>
                <td className="px-6 py-4 text-sm text-right text-black">৳0.00</td>
                <td className="px-6 py-4 text-sm text-right text-black">৳0.00</td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="border-t border-gray-200 px-6 py-3 bg-gray-50">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm font-bold text-black">৳0.00</p>
        </div>
      </div>
    </div>
  );
